...
- Etapa actual: Implementación de Módulos Principales (T-06 en curso)
...
| Testing | Vitest | 18 tests unitarios pasando |
...
4. **Localizador de Grupos y Generaciones (T-06):** Mapeo de avance reticular, visualización de horario semanal consolidado por sección y cálculo de cohorte/generación. (📋 Siguiente)
