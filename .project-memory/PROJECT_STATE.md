...
3. **Base de Datos PostgreSQL:** Tablas estructuradas con índices en (centro, ciclo, profesor, aula, dia, hora_inicio, hora_fin, materia, nrc) y procedimiento almacenado `get_aulas_libres` (actualizado para usar `codigo_modulo`).
